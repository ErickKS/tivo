...
const panelBtnTwo = document.querySelector(
  ".features-panel button:nth-of-type(2)"
);
const panelBtnThree = document.querySelector(
  ".features-panel button:nth-of-type(3)"
);

const featuresOne = document.querySelector(".features .features-single");
const featuresTwo = document.querySelector(
  ".features .features-single:nth-of-type(2)"
);
const featuresThree = document.querySelector(
  ".features .features-single:nth-of-type(3)"
);
